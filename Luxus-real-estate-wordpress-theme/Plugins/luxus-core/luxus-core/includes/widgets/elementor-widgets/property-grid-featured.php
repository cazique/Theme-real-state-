 ...
 * @since 1.1.0
 */
class Luxus_Property_Grid_Featured extends Widget_Base {
	...
	public function get_name() {
		return 'luxus-property-grid-featured';
	}
	...
	public function get_title() {
		return __( 'Featured Property Grid', 'luxus-core' );
	}
	...
	public function get_icon() {
		return 'sl-widget-icon property-featured-grid';
		// return 'far fa-heart';
	}
	...
	private function luxus_style_property_item_options() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property' => 'min-height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .sl-grid-container .featured-property' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],				
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .featured-ribbon span' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .bottom .address' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .bottom .area' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .bottom .features span .sl-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .sl-grid-container .featured-property .title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property' => 'background-size: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .right .sl-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .right a' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .sl-grid-container .featured-property',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property:hover' => 'background-size: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .right a:hover .sl-icon' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .right a:hover' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property .title:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .sl-grid-container .featured-property:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .sl-grid-container .featured-property:hover',
			]
		);
	...
	?>
		...
		<?php
			...
			$luxus_property_grid_featured = new \WP_Query( $query_args );

            if ($luxus_property_grid_featured->have_posts()) :

	        	include( __DIR__ . '/layouts/property-grid-featured/layout-1.php' );
