...
/**
 * Template Name: Schedule Tour Inbox
 */
...
// Custom Page Title
function luxus_schedule_tour_page_title() {
    return esc_html__('Schedule Tour Inbox', 'luxus-core') . ' - ' . get_bloginfo();
}
add_action( 'pre_get_document_title', 'luxus_schedule_tour_page_title' );

global $wpdb;

$current_user = wp_get_current_user();

// Delete Inbox Schedule
require dirname( __FILE__ ) . '/template-parts/delete-inbox-schedules.php';
...
<div class="main-content">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="heading-one"><?php esc_html_e('Schedules: Inbox', 'luxus-core'); ?></h2>
            </div>
            <div class="col-lg-12">
                <?php
                ...
                <?php
                    ...
                    if ( count($schedules) > 0 ) :
                        ...
                        foreach ( $schedules as $schedule ) {
                            ...
                            $sch_url = site_url('schedule/?sch=inbox&id=') . $sch_id;

                            $sender_data = get_userdata( $schedule->sender_id );
                        ...
                        <div class="msg-container <?php echo esc_attr($sch_status); ?>">
                            ...
                            <div class="action">
                                ...
                                <form method='post' name='del-sch-<?php echo esc_attr($sch_id); ?>' id='del-sch-<?php echo esc_attr($sch_id); ?>' action=''>
                    ...
                    <?php
                        ...
                        <div class="alert-message alert-message-info">
                            <h6><?php esc_html_e('Empty Schedules Inbox', 'luxus-core'); ?></h6>
                        <p><?php esc_html_e('Sorry! No Schedules Received yet!.', 'luxus-core'); ?></p>
                        </div>
...
wp_register_script( 'luxus-schedule-inbox', '', array('jquery'), '', true );
wp_enqueue_script( 'luxus-schedule-inbox'  );

wp_add_inline_script( 'luxus-schedule-inbox', '
