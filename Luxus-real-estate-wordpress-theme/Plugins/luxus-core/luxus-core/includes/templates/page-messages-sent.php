...
/**
 * Template Name: Messages Sent
 */

// Custom Page Title
function luxus_message_sent_page_title() {
    return esc_html__('Message Sent', 'luxus-core') . ' - ' . get_bloginfo();
}
add_action( 'pre_get_document_title', 'luxus_message_sent_page_title' );
...
require dirname( __FILE__ ) . '/template-parts/delete-sent-messages.php';
...
<div class="main-content">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="heading-one"><?php esc_html_e('Messages: Sent', 'luxus-core'); ?></h2>
            </div>
            <div class="col-lg-12">
            <?php
                ...
                <?php
                    ...
                    if ( count($messages) > 0 ) {
                        ...
                        foreach ( $messages as $message ) :
                            ...
                            $msg_url = site_url('message/?msg=sent&id=') . $msg_id;

                            $reciever_data = get_userdata( $message->receiver_id );
                    ...
                    <?php endforeach;
                        ...
                        <div class="alert-message alert-message-info">
                            <h6><?php esc_html_e('Sent Messages Empty', 'luxus-core'); ?></h6>
                            <p><?php esc_html_e('Sorry! No Messages Sent yet!.', 'luxus-core'); ?></p>
                        </div>
               <?php } ?>
            </div>
            <?php
...
wp_register_script( 'luxus-message-sent', '', array('jquery'), '', true );
wp_enqueue_script( 'luxus-message-sent'  );

wp_add_inline_script( 'luxus-message-sent', '
