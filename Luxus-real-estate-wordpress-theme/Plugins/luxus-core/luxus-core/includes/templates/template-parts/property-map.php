...
/**
 * Template Part For Map Templates
 */
...
// For Map Infobox
$property_type_name = !empty($property_type) ? $property_type->name : 'NA';
$property_status_name = !empty($property_status) ? $property_status->name : 'NA';
