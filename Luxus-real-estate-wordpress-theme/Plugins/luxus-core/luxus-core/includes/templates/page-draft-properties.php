...
/**
 * Template Name: Draft Properties
 */
...
// Custom Page Title
function luxus_draft_properties_page_title() {
    return esc_html__('Draft Properties', 'luxus-core') . ' - ' . get_bloginfo();
}
add_action( 'pre_get_document_title', 'luxus_draft_properties_page_title' );
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2 class="heading-one"><?php esc_html_e('Drafts Properties', 'luxus-core'); ?></h2>
            </div>
        </div>
        <div class="row">
            <?php
            ...
            <?php endwhile;
                ...
                <div class="col-lg-12">
                    <div class="alert-message alert-message-info">
                        ...
                        <p><?php esc_html_e('Sorry! No Properties found in Draft.', 'luxus-core'); ?></p>
                    </div>
                </div>
            <?php endif; ?>
