				...
				$(parentItems).each(function() {
					if( $(this).hasClass('mega') ) {
						...
						$(this).on('mouseenter', function(){
							$(this).find('ul').first().slideDown(settings.openingSpeed);
						});
						$(this).on('mouseleave', function(){
							$(this).find('ul').first().slideUp(settings.openingSpeed);
						});
					} else {
						// normal dropdown
						// first-level
						$(this).on('mouseenter', function(){
							$(this).children('ul').fadeIn(settings.openingSpeed);
						});
						$(this).on('mouseleave', function(){
							$(this).children('ul').fadeOut(settings.openingSpeed);
						});
